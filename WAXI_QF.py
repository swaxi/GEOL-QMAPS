...
class WAXI_QF:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "WAXI_QF_{}.qm".format(locale)
        )
    ...
    def export_layer_fill_Table1(self, couche):
        ...
        emplacement_files_WAXI_columns = os.path.join(
            ...
            self.dir_99 + "/columns_reference_WAXI4.xlsx",
        )
    ...
    def button_edit2(self, row):
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference = pd.read_csv(
                emplacement_99_CSV_files + "Metamorphic lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference1 = pd.read_csv(
                emplacement_99_CSV_files + "Plutonic lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference2 = pd.read_csv(
                emplacement_99_CSV_files + "Volcanic lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference3 = pd.read_csv(
                emplacement_99_CSV_files + "Volcanoclastic lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference4 = pd.read_csv(
                emplacement_99_CSV_files + "Sedimentary lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference5 = pd.read_csv(
                emplacement_99_CSV_files + "Supergene lithologies.csv", sep=";"
            )
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_reference6 = pd.read_csv(
                emplacement_99_CSV_files + "Local lithologies.csv", sep=";"
            )
        ...
        if not self.row_edit_status[row]:
            ...
            rock_types = {
                "      ---Plutonic---      ": list_litho_plutonic,
                "      ---Volcanic---      ": list_litho_volcanic,
                "      ---Sedimentary---      ": list_litho_sedimentary,
                "      ---Metamorphic---      ": list_litho_metamorphic,
                "       ---Supergene---      ": list_litho_supergene,
                "      ---Volcanoclastic---      ": list_litho_volcanoclastic,
    ...
    def lithologies_sorting(
        ...
        litho_local = list(
            (pd.read_csv(emplacement_99_CSV_files + "Local lithologies.csv", sep=";"))[
                "Valeur"
            ]
        )
        litho_supergene = list(
            (
                pd.read_csv(
                    emplacement_99_CSV_files + "Supergene lithologies.csv", sep=";"
                )
        ...
        for k in range(len(worksheets_lithology)):
            ...
            litho_output = fichier_output_lithology.create_sheet(
                name_worksheet1.split(".")[0]
            )
        ...
        for k in range(0, len(fichier_output["Litho"])):
            ...
            if r in litho_local and r != "Unknown":
                ...
                header_local = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Local lithologies_PT_" + name_input_file).split(".")[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
                ligne = []
            ...
            # litho_supergene :
                ...
                header_supergene = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Supergene lithologies_PT_" + name_input_file).split(".")[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
                ligne = []
            ...
            # litho_sedimentary :
                ...
                header_sedimentary = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Sedimentary lithologies_PT_" + name_input_file).split(".")[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
                ligne = []
            ...
            # litho_volcanoclastic :
                ...
                header_volcanoclastic = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Volcanoclastic lithologies_PT_" + name_input_file).split(".")[
                            0
                        ]
                    ].iter_cols(min_row=1, max_row=1)
                ]
                ...
                fichier_output_lithology[
                    ("Volcanoclastic lithologies_PT_" + name_input_file).split(".")[0]
                ].append(ligne)
            ...
            # litho_volcanic :
                ...
                header_volcanic = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Igneous extrusive lithologies_PT_" + name_input_file).split(
                            "."
                        )[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
            ...
            # litho_plutonic :
                ...
                header_plutonic = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Igneous intrusive lithologies_PT_" + name_input_file).split(
                            "."
                        )[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
            ...
            # litho_metamorphic :
                ...
                header_metamorphic = [
                    col[0].value
                    for col in fichier_output_lithology[
                        ("Metamorphic lithologies_PT_" + name_input_file).split(".")[0]
                    ].iter_cols(min_row=1, max_row=1)
                ]
                ligne = []
    ...
    def fill_Table3(self, fichier_output):
        ...
        emplacement_files_WAXI_columns = os.path.join(
            os.path.dirname(WAXI_projet_path),
            self.dir_99 + "/columns_types_structures_WAXI4.xlsx",
        )
    ...
    def structure_sorting(
        ...
        for k in range(len(worksheets_structure)):
            ...
            structure_output = fichier_output_structures.create_sheet(
                name_worksheet2.split(".")[0]
            )
                ...
                for sheet in fichier_output_structures.sheetnames:
                    if sheet != "Sheet":
                        if type_structure2 == sheet:
                            ...
                            header_reference = [
                                col[0].value
                                for col in fichier_output_structures[sheet].iter_cols(
                                    min_row=1, max_row=1
                                )
                            ]
    ...
    def clipToCanvas(self):
        ...
        if self.dlg.lineEdit_3.text():
            ...
            copies = [
                ...
                [
                    in_pref + "columns_reference_WAXI4.xlsx",
                    out_pref + "columns_reference_WAXI4.xlsx",
                ],
                [
                    in_pref + "columns_types_structures_WAXI4.xlsx",
                    out_pref + "columns_types_structures_WAXI4.xlsx",
                ],
    ...
    def mergeProjects(self):
        ...
        if (
            ...
            mainGpkgPath = self.mynormpath(
                main_project_path + self.dir_0 + "CURRENT MISSION.gpkg"
            )
            subGpkgPath = self.mynormpath(
                sub_project_path + self.dir_0 + "CURRENT MISSION.gpkg"
            )
            mergeGpkgPath = self.mynormpath(
                merge_project_path + self.dir_0 + "CURRENT MISSION.gpkg"
            )
            ...
            dirs = [
                ...
                merge_project_path + self.dir_99 + "CSV FILES",
            ]
            ...
            for file in csvs.name:
                ...
                sub_path = self.mynormpath(
                    sub_project_path + self.dir_99 + "/CSV FILES/" + file + ".csv"
                )
                merge_path = self.mynormpath(
                    merge_project_path + self.dir_99 + "/CSV FILES/" + file + ".csv"
                )
            ...
            dst_file = (
                merge_project_path + self.dir_0 + "/CURRENT MISSION+CSV FILES.qlr"
            )
            ...
            if len(points) > 0:
                ...
                if not merged_layers.isValid():
                    ...
                    virtual_path = self.mynormpath(
                        output_path
                        + self.dir_0
                        + "/CURRENT MISSION.gpkg|layername=Virtual_Stops_"
                        + datestamp
                    )
        ...
        if os.path.exists(self.mynormpath(self.dlg.lineEdit_18.text())):
            ...
            if groupe_field_data:
                ...
                chemin_complet = os.path.join(
                    chemin_qlr, "CURRENT MISSION+CSV FILES.qlr"
                )
            ...
            self.iface.messageBar().pushMessage(
                (
                    "A new CURRENT MISSION + CSV FILES.qlr file was saved in "
                    + chemin_qlr
                ),
                level=Qgis.Success,
                duration=15,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr("&WAXI_QF"), action)
    ...
    def update_combobox_delete(self):
        ...
        if os.path.exists(emplacement_99_CSV_files):
            fichier_delete = pd.read_csv(
                emplacement_99_CSV_files + self.dlg.comboBox.currentText() + ".csv",
                encoding="latin_1",
                sep=";",
            )
