...
def _tr(text):
    return QCoreApplication.translate("GEOL_QMAPSDockWidgetBase", text)
...
class GEOL_QMAPSDockWidget(QDockWidget):
    ...
    def _tab_import(self):
        ...
        self.groupBox_3 = _gb(W, _tr("Step 3: Generate Standardised Legacy Data (Scratch)"),
                               400, 40, 371, 61)
        self.pushButton_14 = _btn(self.groupBox_3, _tr("Generate QGIS Layers"), 120, 30, 141, 21)
        ...
        self.merge_layers_pushButton_2 = _btn(self.groupBox_15, _tr("Merge Layers"), 270, 100, 91, 21)
        ...
        # Reset button
        self.pushButton_13 = _btn(W, _tr("RESET THE WINDOW"), 630, 200, 141, 21)
    ...
    def _tab_fieldwork(self):
        ...
        # Edit Dictionaries
        self.groupBox_5 = _gb(W, _tr("Edit Dictionaries"), 10, 240, 761, 91, ptsize=12)
        _lbl(self.groupBox_5, _tr("Dictionary: "), 10, 20, 81, 41)
        self.comboBox = _cb(self.groupBox_5, 70, 30, 431, 21,
                             _tr("Select a dictionary to update"))
        _lbl(self.groupBox_5, _tr("Item to Add:"), 10, 60, 71, 21)
        self.lineEdit_38 = _le(self.groupBox_5, 80, 60, 211, 21, _tr("Type the item to add"))
        self.csv_pushButton = _btn(self.groupBox_5, _tr("Add Item"), 300, 60, 61, 21)
        vline = QFrame(self.groupBox_5)
        vline.setGeometry(350, 60, 20, 21)
        vline.setFrameShape(QFrame.VLine)
        vline.setLineWidth(1)
        _lbl(self.groupBox_5, _tr("Item to Delete:"), 380, 60, 101, 21)
        self.comboBox_delete = _cb(self.groupBox_5, 470, 60, 201, 21,
                                    _tr("Select the item to delete"))
        self.csv_pushButton_2 = _btn(self.groupBox_5, _tr("Delete Item"), 680, 60, 71, 21)
        ...
        self.groupBox_17 = _gb(
            W, _tr("Save Changes Made to the Field Data Forms"), 10, 450, 761, 81, ptsize=12)
        self.label_36 = _lbl(
            self.groupBox_17,
        ...
        self.pushButton_save__project_template_style_2 = _btn(
            self.groupBox_17, _tr("Save .qlr File"), 660, 50, 91, 21)

        # Clip Field Data to Current Canvas
        self.groupBox_4 = _gb(
            W, _tr("Clip Field Data to Current Canvas"), 10, 560, 761, 91, ptsize=12)
        _lbl(self.groupBox_4, _tr("Path to New Directory:"), 10, 30, 121, 21,
             align=Qt.AlignRight | Qt.AlignVCenter)
        _lbl(self.groupBox_4, _tr("Clipping Polygon (optional):"), 10, 60, 161, 21)
        ...
        self.clip_pushButton = _btn(self.groupBox_4, _tr("Clip"), 720, 60, 31, 21, _BTN)

        # Bottom bar
        self.pushButton_19 = _btn(W, _tr("RESET THE WINDOW"), 620, 660, 141, 21)
    ...
    def _tab_data_mgmt(self):
        ...
        self.rejig_pushButton_4 = _btn(self.groupBox_22, _tr("Update Version"), 650, 30, 101, 21)

        # Sync QField to QGIS
        self.groupBox_23 = _gb(
            W, _tr("Synchronise a QField Package to the QGIS Master Project"),
            10, 110, 761, 61, ptsize=12)
        _lbl(self.groupBox_23, _tr("QField Package:"), 10, 30, 91, 21)
        ...
        self.pushButton_QGISFolder = _btn(self.groupBox_23, "...", 650, 30, 31, 21,
                                           _BTN_BROWSE)
        self.pushButton_SyncQFieldToQGIS = _btn(self.groupBox_23, _tr("Sync"), 700, 30, 51, 21)

        # Merge Projects
        self.groupBox_8 = _gb(W, _tr("Merge Projects"), 10, 200, 761, 91, ptsize=12)
        _lbl(self.groupBox_8, _tr("Path to Main Project:"), 10, 30, 121, 21)
        ...
        _lbl(self.groupBox_8, _tr("Path to Sub-Project:"), 10, 50, 111, 31,
             align=Qt.AlignRight | Qt.AlignVCenter)
        ...
        _lbl(self.groupBox_8, _tr("Path to New Directory:"), 400, 30, 121, 21,
             align=Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.merge_pushButton = _btn(self.groupBox_8, _tr("Merge Projects"), 650, 60, 101, 21)

        # Archive Current Field Data
        self.groupBox_21 = _gb(W, _tr("Archive Current Field Data"), 10, 320, 371, 61, ptsize=12)
        ...
        self.groupBox_9 = _gb(
            W, _tr("Remove Duplicate UUIDs from Project"), 400, 320, 371, 61, ptsize=12)
        fi = QFont("Arial")
        fi.setItalic(True)
        lbl25 = QLabel(_tr("Should be used after merging operations"), self.groupBox_9)
        lbl25.setGeometry(10, 30, 211, 21)
        lbl25.setFont(fi)
        self.merge_pushButton_2 = _btn(self.groupBox_9, _tr("Remove Duplicates"), 240, 30, 121, 21)

        # Export Compilation Layers
        self.groupBox_10 = _gb(
            W, _tr("Export Compilation Layers to Common Themes"), 10, 410, 491, 91, ptsize=12)
        _lbl(self.groupBox_10, _tr("Path to Export Directory:"), 10, 30, 141, 21)
        ...
        self.export_pushButton = _btn(self.groupBox_10, _tr("Export Layers"), 390, 60, 91, 21)

        # Create Virtual Stops
        self.groupBox_11 = _gb(W, _tr("Create Virtual Stops"), 510, 410, 261, 91, ptsize=12)
        _lbl(self.groupBox_11, _tr("Minimal Neighbour Distance (m) :"), 10, 30, 181, 21)
        ...
        # Picture Management
        self.groupBox_16 = _gb(W, _tr("Picture Management"), 10, 530, 761, 141, ptsize=12)
        ...
        self.pushButton_update_source_photo = _btn(
            self.groupBox_16, _tr("Update Repository"), 630, 70, 121, 21)
        _lbl(self.groupBox_16,
        ...
        # Bottom bar
        self.pushButton_22 = _btn(W, _tr("RESET THE WINDOW"), 630, 710, 141, 21)
    ...
    def _tab_help(self):
        ...
        self.pushButton_34 = _btn(gb14, _tr("Zenodo Repository "), 320, 30, 121, 21, _HELP_BTN)
        ...
        self.plainTextEdit_8 = _pte(
            ...
            "plainTextEdit_8")
        self.pushButton_24 = _btn(gb13, _tr("Send Email"), 110,  80, 81, 21, _HELP_BTN)
        self.pushButton_21 = _btn(gb13, _tr("User Guide"), 130, 110, 81, 21, _HELP_BTN)
        ...
        self.plainTextEdit_9 = _pte(
            ...
            _tr("If you have bugs to report, suggestions for improvements or new tools "
                ...
                "or contact us !"),
            "plainTextEdit_9")
        self.pushButton_23 = _btn(gb30, _tr("Bug Report"),  60, 110,  91, 21, _HELP_BTN)
        self.pushButton_28 = _btn(gb30, _tr("Send Email"), 210, 110,  81, 21, _HELP_BTN)
        ...
        self.plainTextEdit_11 = _pte(
            ...
            "plainTextEdit_11")
        self.pushButton_30 = _btn(gb33, _tr("User Guide - Roadmap"), 300, 30, 141, 21, _HELP_BTN)
        ...
        self.plainTextEdit_5 = _pte(
            ...
            "plainTextEdit_5")
        self.pushButton_41 = _btn(gb31, _tr("WAXI website"),  260, 70, 121, 21, _HELP_BTN)
        self.pushButton_40 = _btn(gb31, _tr("AMIRA website"), 400, 70, 121, 21, _HELP_BTN)
